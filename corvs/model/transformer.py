...
from corvs.model.embedding import RotaryPositionalEmbeddings
...
class TransformerEncoderLayer(nn.TransformerEncoderLayer):
    ...
    def __init__(
            ...
            dropout: float = 0.1,
            activation: nn.Module | Callable[[torch.FloatTensor], torch.FloatTensor] | Literal["relu", "gelu", "swiglu"] = F.relu,
