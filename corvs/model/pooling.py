...
def masked_global_soft_pool1d(input: torch.FloatTensor, valid_mask: torch.BoolTensor, temp: float | torch.FloatTensor = 1) -> torch.FloatTensor:
    """
