...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--traj_track_id", type=int, required=True, help="track ID of trajectory")
    parser.add_argument("-s", "--sensor_worker_id", type=int, required=True, help="worker ID of sensor measurements")
    parser.add_argument("--from", help="start datetime in JST", dest="from_")
    parser.add_argument("--to", help="end datetime in JST")
